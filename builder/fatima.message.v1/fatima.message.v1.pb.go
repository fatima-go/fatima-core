...
func (x *SendFatimaMessageResponse) GetResponse() isSendFatimaMessageResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *SendFatimaMessageResponse) GetSuccess() *ResponseSuccess {
	if x != nil {
		if x, ok := x.Response.(*SendFatimaMessageResponse_Success); ok {
			return x.Success
		}
	}
	return nil
...
func (x *SendFatimaMessageResponse) GetError() *ResponseError {
	if x != nil {
		if x, ok := x.Response.(*SendFatimaMessageResponse_Error); ok {
			return x.Error
		}
	}
	return nil
...
var file_fatima_message_v1_proto_rawDesc = string([]byte{
...
var (
	...
	file_fatima_message_v1_proto_rawDescData []byte
)

func file_fatima_message_v1_proto_rawDescGZIP() []byte {
	file_fatima_message_v1_proto_rawDescOnce.Do(func() {
		file_fatima_message_v1_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fatima_message_v1_proto_rawDesc), len(file_fatima_message_v1_proto_rawDesc)))
	})
...
var file_fatima_message_v1_proto_goTypes = []any{
...
func file_fatima_message_v1_proto_init() {
	...
	file_fatima_message_v1_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fatima_message_v1_proto_rawDesc), len(file_fatima_message_v1_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
